...
namespace wdmg\reviews\controllers;

use Yii;
use wdmg\reviews\models\Reviews;
use wdmg\reviews\models\ReviewsSearch;
...
class ReviewsController extends Controller
{
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('app/modules/reviews', 'The requested page does not exist.'));
    }
}
